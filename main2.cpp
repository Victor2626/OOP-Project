...
void adauga_cost(vector<Cost>& costuri, const Cost& cost) {
    costuri.push_back(cost);
}
void afiseaza_costuri(const std::vector<Cost>& costuri) {
...
int main() {
    ...
    cout<<"\n";
    vector<Cost> costuri;
    Cost cost4(1500, 2500, 3500, 2000);
    Cost cost5(1200, 2200, 3100, 1800);
    Cost cost6(1300, 2400, 3300, 1900);
    adauga_cost(costuri, cost4);
    adauga_cost(costuri, cost5);
    adauga_cost(costuri, cost6);
    afiseaza_costuri(costuri);
    cout<<"\n";
    Angajat angajat1;
    cout<<angajat1<<endl;
    cout<<"\n";
